...
@section('content')
<div class="col-md-12 col-xs-12 right-section m-top-5" data-ng-controller="usersCtrl" id="streams">
    <div class="row">
      
       <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="panel panel-default solid-corner user-detail">
          <div class="panel-body breakWord">
              <div class="icon">
                <i class="fa fa-user f-25"></i>
              </div>
               <div class="form-group text-center">
                 <img class="profile-photo" ng-src="{[{ userInfo.photoUrl }]}">
               </div>

               <div class="form-group text-center profile-info">
                 
                  <button class="btn btn-default" ng-click="showFollows(userInfo.uid)">
                      <i class="fa fa-users"></i>
                  </button>
                  
                  <button ng-controller="mainCtrl" class="btn btn-default" ng-click="$main.$settings();" ng-if="userInfo.isCurrentUser">
                      <i class="fa fa-gears"></i>
                  </button>
                  
                  <span ng-if="!userInfo.isCurrentUser">
                    <button class="btn btn-default" ng-click="followUser(userInfo.uid)" ng-if="!checkIfAlreadyFollowed(userInfo.uid, authenticatedUser.uid) && authenticatedUser.uid != userInfo.uid"><i class="fa fa-user-plus"></i></button>
                    <button class="btn btn-default" ng-click="unFollowUser(userInfo.uid)" ng-if="checkIfAlreadyFollowed(userInfo.uid, authenticatedUser.uid) && authenticatedUser.uid != userInfo.uid"><i class="fa fa-user-times"></i></button>
                  </span>
                  
                  <h4 ng-bind="userInfo.firstname + ' ' + userInfo.lastname" class="no-m-bottom"></h4>
                  <p class="text-primary" ng-bind="userInfo.email"></p>
    	...
    	<div class="col-md-5 col-sm-12 col-xs-12">
  		<div class="comment-section" ng-if="userInfo.isCurrentUser">
  			<form ng-submit="$streams.$save()" name="Form" novalidate="">
	  			<div class="form-group">
  	  				<div class="row">
                
                  <div class="col-md-2 col-sm-2 col-xs-2">
                      <img ng-src="{[{ userInfo.photoUrl }]}" class="img-circle" id="streamNewPostImg" >
    	            </div>
    ...
    <hr ng-if="userInfo.isCurrentUser">        
<!-- start -->
            ...
            <div class="panel panel-default panel-google-plus">
                ...
                <div class="panel-heading">
                    ...
                    <script type="text/ng-template" id="post_profile.html">
                        ...
                        <div class="form-group text-center">
                                 <p class="lead no-m-bottom hand" ng-click="mentionClick(list.uid)" data-ng-bind="list.userInfo.fullname"></p>
                    ...
                    <script type="text/ng-template" id="options.html">
                      <div class="form-group optionDiv no-m-bottom">
                        <ul class="no-m-bottom" style="padding: 0px; list-style: none">
                          <li ng-if="userInfo.isCurrentUser">
                            <a href="#" ng-click="showEditModal(list)"><i class="fa fa-pencil fa-fw"></i> Edit Post</a>
                          </li>
                          <li ng-if="userInfo.isCurrentUser">
                            <a href="#" ng-click="deletePost(list)"><i class="fa fa-trash fa-fw"></i> Delete Post</a>
                          </li>
                          <li>
  ...
  <div class="col-md-4 col-sm-12 col-xs-12">
        <div class="panel panel-default solid-corner watchlist">
          <div class="panel-body">
              ...
              <ul class="list-group">       
                <li class="list-group-item" ng-repeat="symbolDetails in watchList">
...
<script type="text/ng-template" id="editStreamsModal.html">

        <div class="modal-header">
           <h4 class="pull-left">Edit Post</h3>
        ...
        <div class="modal-body" id="modal-body" style="max-height: 250px">
          ...
          <div class="form-group no-m-bottom post-box" style="position: relative;">
              <div ng-model="stream.post" id="editPostTxArea" class="form-control postTextArea" contentEditable="true" at-who user-data="userData" symbol-data="symbolData" auto-resize start-height="100" data-text="Share your idea about stocks"></div>
        ...
        <div class="modal-footer">
            <button class="btn btn-info" ng-disabled="!stream.post.length" ng-click="updatePost()">
...
<script type="text/ng-template" id="followsModal.html">
        <div class="modal-header">
           <ul class="nav nav-pills pull-left">
              <li ng-class="{'active' : options === 'following'}" ng-click="options = 'following'"><a href="#">Following (<span ng-bind="following.length"></span>)</a></li>
              <li ng-class="{'active' : options === 'followers'}" ng-click="options = 'followers'"><a href="#">Followers (<span ng-bind="followers.length"></span>)</a></li>
           </ul>         
           <i class="fa fa-times hand pull-right" style="margin-top: 13px;
    margin-right: 5px;" ng-click="close()"></i>
        </div>
        <div class="modal-body" id="modal-body" style="max-height: 250px">
           <ul ng-scrollbars ng-scrollbars-config="config" ng-if="options === 'following'" style="max-height: 210px; padding: 0; list-style-type: none;">
              <li class="w-100 p-left-5" ng-repeat="user in following">
                <div class="row w-100">
                     <div class="col-md-2">
                        <img class="imgCircle" ng-src="{[{ user.photoUrl }]}" alt="profile">
                     </div>
              ...
              <li class="w-100 p-left-5" ng-if="!following.length">
                <div class="row w-100">
                  <div class="col-md-12 text-center f-25">
                    <i class="fa fa-ban"></i> No Result Found
                  </div>    
           ...
           <ul ng-scrollbars ng-scrollbars-config="config" style="max-height: 210px; padding: 0; list-style-type: none;" ng-if="options === 'followers'">
             <li class="w-100 p-left-5" ng-repeat="user in followers" >
                <div class="row w-100">
                     <div class="col-md-2">
                        <img class="imgCircle" ng-src="{[{ user.photoUrl }]}" alt="profile">
                     </div>
              ...
              <li class="w-100 p-left-5" ng-if="!followers.length">
                <div class="row w-100">
                  <div class="col-md-12 text-center f-25">
                    <i class="fa fa-ban"></i> No Result Found
                  </div>    
...
@section('page-js')
<!-- Controller JS -->
<script type="text/javascript" src="/app/fe-app/controllers/user_detail.js"></script>
