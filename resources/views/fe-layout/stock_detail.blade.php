...
@section('content')
<div class="col-md-12 col-xs-12 right-section m-top-5" data-ng-controller="stockDetailCtrl" id="streams">
    <div class="row">
       
        <div class="col-md-3 col-sm-12 col-xs-12">
         <div class="panel panel-default solid-corner w-100 stock-detail" style="position: relative;">
            <div class="watchlist-btn">
              <button class="btn btn-default pull-right" ng-if="isObjectEmpty(watchData)" ng-click="watchSymbol(symbolDetails.symbol)" ><i class="fa fa-eye"></i></button>
              <button class="btn btn-default pull-right" ng-if="!isObjectEmpty(watchData)" ng-click="unWatchSymbol(watchData)" ><i class="fa fa-eye-slash"></i></button>
            </div>
            <div class="panel-body breakWord">
              <div ng-if="!isDetailLoads" class="isLoaded">
                <i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
                <span class="sr-only">Loading...</span>
              </div>
              <div ng-if="isDetailLoads">
                <div class="w-100">
                  <span class="f-12" ng-bind="symbolDetails.name"></span>
                </div>
                <div class="w-100 clearfix">
                  <span class="f-25 bolder pull-left" ng-bind="symbolDetails.symbol"></span>
                  <span class="pull-left f-15  m-top-5 m-left-15" ng-class="{'rate-up-text' : symbolDetails.change >= 0,'rate-down-text' :  symbolDetails.change < 0 }" >
                     <span class="f-18 text-muted" ng-bind="symbolDetails.open"></span>
                     <span class="fa fa-fw" ng-class="{'fa-arrow-circle-o-up' : symbolDetails.change >= 0,'fa-arrow-circle-o-down' : symbolDetails.change < 0 }">
                     </span>
                     <span ng-bind="symbolDetails.change"></span>
                     (<span ng-bind="symbolDetails.percentage"></span>)
                   </span>
                </div>
                <div class="w-100 secondaryDetailBg">
                  <div class="item">Prev Close <strong class="pull-right" ng-bind="symbolDetails.previousClose"></strong></div>
                  <div class="item">Open <strong class="pull-right" ng-bind="symbolDetails.open"></strong></div>
                  <div class="item">Low <strong class="pull-right" ng-bind="symbolDetails.low"></strong></div>  
                  <div class="item">High <strong class="pull-right" ng-bind="symbolDetails.high"></strong></div>  
                  <div class="item">Volume <strong class="pull-right" ng-bind="symbolDetails.volume"></strong></div>  
                </div>
              </div>
            </div>
            <div class="watchlist-lbl">
              <i class="fa fa-users"></i> <span ng-bind="watchers"></span>
            </div>
         </div>
       </div>
       <!-- <div class="col-md-3 col-sm-12 col-xs-12">
        <div class="panel panel-default solid-corner" style="width: 100%">
         <div class="panel-heading solid-corner clearfix">
           
            <label class="pull-left" style="margin-top: 8px">
                <i class="fa fa-users"></i> <span ng-bind="watchers"></span>
             </label>
            <button class="btn btn-info btn-rounded pull-right" ng-if="isObjectEmpty(watchData)" ng-click="watchSymbol(symbolDetails.symbol)" ><i class="fa fa-eye"></i> Watch</button>
            <button class="btn btn-info btn-rounded pull-right" ng-if="!isObjectEmpty(watchData)" ng-click="unWatchSymbol(watchData)" ><i class="fa fa-eye-slash"></i> Unwatch</button>
            
          </div> 
          <div class="panel-body breakWord" style="position: relative; height:235px;">
            <div ng-if="!isDetailLoads" style="position: absolute; width: 100%;height: 100%; top: 40%;left: 40%;">
              <i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
              <span class="sr-only">Loading...</span>
            </div>
            <div ng-if="isDetailLoads">
...
@section('page-js')
<!-- Controller JS -->
<script type="text/javascript" src="/app/fe-app/controllers/stock_detail.js"></script>
