...
@section('content')	            
<div class="col-md-12 col-xs-12 right-section m-top-10" data-ng-controller="asxCtrl" id="announcement">
	...
	<div class="bg-inverse text-white clearfix">
  	...
  	<div class="collapse" id="filterSection">
        ...
        <div class="col-md-12 m-top-15 divider remove_padding">
        </div>
...
@section('page-js')
    <!-- Controller JS -->
    <script type="text/javascript" src="/app/fe-app/controllers/announcement/asx.js"></script>
    <!-- Controller JS -->
