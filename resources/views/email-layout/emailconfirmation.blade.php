                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Your HotCopper account has now been approved, so welcome to our community of investors - our members have been scouting the next ten baggers for almost 15 years and are an integral part of our site.</p>
                         <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">We hope you’ve taken a look around and familiarised yourself with both our Terms of Use and posting guidelines, noting that we are a profanity-free site seeking educated and civil debate. In addition, rules on defamatory posts are strict, so please make sure you’ve read our defamation guidelines.</p>
                            ...
                            <tr>
                              <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                  <tbody>
                                    <tr>
                                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #f57321; border-radius: 0px; text-align: center;"> <a href="{{ url('/api/authentication/activated/'.$data['token']) }}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #f57321; border: solid 1px #f57321; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #f57321;width:100%">Go to the HotCopper site</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">For any further assistance with your account, please contact Support on info@hotcopper.com.au or click the support link at the bottom of the site.</p>
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Enjoy your membership.</p>
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                ...
                <tr>
                 ...
                 <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                    <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">You are receiving this email because you are a member of HotCopper,<br/> which is owned and operated by <br/> Report Card Pty Ltd. ABN: 39 092 598 859 ACN: 092 598 859.</span>
                  </td>
                </tr>
                <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 0px; padding-top: 0; font-size: 12px; color: #999999; text-align: center;">
